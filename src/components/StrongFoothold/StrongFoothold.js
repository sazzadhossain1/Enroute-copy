...
import EnrouteIndustry from "../EnrouteIndustry/EnrouteIndustry";
...
const StrongFoothold = () => {
  return (
    <div>
      <div className="strongFoothold-parent-div">
        <div className="strongFoothold-child-div">
          <h1 className="strongFoothold-heading">
            We Have A <span className="text-color">Strong Foothold </span> in
            The Following
          ...
          <div>
            ...
            <div className="strongFoothold-textAndLogo-div">
              ...
              <div className="strongFoothold-left-text-container">
                ...
                <p className="strongFoothold-p">
                  We are transforming the financial service through
                  digitalization and changes in fundamental aspects enabling
                  their capabilities for the future of banking and finance.
                </p>
              </div>
            </div>
          </div>
      ...
      <EnrouteIndustry></EnrouteIndustry>
    </div>
  );
};
